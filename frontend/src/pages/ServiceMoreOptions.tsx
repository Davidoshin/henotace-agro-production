...
export default function ServiceMoreOptions() {
  ...
  const allServiceOptions: ServiceOption[] = [
    ...
    { 
      ...
      path: "/manage-account?view=notifications",
      color: "text-red-500",
      bgColor: "bg-red-500/10",
    ...
    <div className="min-h-screen bg-background pb-20">
      ...
      <div className="p-4 space-y-6">
        ...
        {serviceOptions.map((section, sectionIndex) => {
          ...
          const showMore = section.items.length > 4;
          const visibleItems = showMore && !isExpanded 
          ...
          return (
            <div key={sectionIndex}>
              ...
              {/* Desktop: 4 per row grid, Mobile: list */}
              <div className="hidden md:grid md:grid-cols-4 gap-3">
                    ...
                    <CardContent className="p-4">
                      <div className="flex flex-col items-center gap-2 text-center">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-muted-foreground">+{section.items.length - 4} items</p>
                        </div>
                      </div>
                    </CardContent>
                  </Card>
              ...
              {/* Collapse button when expanded on desktop */}
              {showMore && isExpanded && (
