...
function CustomerTracking() {
  ...
  const businessColors = useBusinessColors();
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-gray-900 dark:to-gray-800">
      ...
      <div className="container mx-auto px-4 py-8 max-w-6xl">
        {/* QR Code Section */}
        {shipment && (
          <Card className="mb-8" style={{ background: `linear-gradient(to right, ${businessColors.primary_color}, ${businessColors.secondary_color})` }}>
            <CardContent className="p-8 text-center">
              <div className="flex flex-col items-center gap-6">
                <div className="bg-white p-4 rounded-xl shadow-lg">
                  <QRCodeSVG
                    ref={qrRef}
                    value={`${window.location.origin}/shipment-track/${shipment.tracking_code}`}
                    size={200}
                    level="H"
                    includeMargin={true}
                    bgColor="white"
                    fgColor={businessColors.primary_color}
                  />
                </div>
                <div>
                  <h2 className="text-3xl font-bold mb-2" style={{ color: businessColors.text_color }}>{shipment.tracking_code}</h2>
                  <p className="text-lg opacity-90 mb-4" style={{ color: businessColors.text_color }}>Scan to Track Shipment</p>
                ...
                <CardContent className="space-y-4">
                  <div className="text-center">
                    <div className="flex items-center justify-center gap-2 mb-2">
                      {shipment.mode_of_movement === 'air_freight' && <Plane className="h-6 w-6 text-blue-500" />}
                      {shipment.mode_of_movement === 'sea_transport' && <Ship className="h-6 w-6 text-blue-500" />}
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  {shipment.product_name && (
                    <div>
                      <p className="font-medium text-lg">{shipment.product_name}</p>
