...
export default function AgroProducePage() {
  ...
  const handleRestock = async () => {
    ...
    setRestocking(true);
    try {
      const result = await apiPostOptimistic(`agro/produce/${restockData.produce_id}/restock/`, {
      ...
      toast({
        title: offlineQueued ? "Restock queued" : "Produce restocked",
        description: offlineQueued
          ? "Stock restock will sync when you are back online."
          : "Farm produce stock has been updated.",
      });
          ...
          <DialogContent className="max-w-md">
            ...
            <div className="space-y-4 pt-2">
              <div className="space-y-2">
                <Label htmlFor="restock-produce-item">Farm Produce</Label>
                <select
                  id="restock-produce-item"
              ...
              <div className="space-y-2">
                <Label htmlFor="restock-produce-qty">Quantity Added</Label>
                <Input
                  id="restock-produce-qty"
                  type="number"
                  min="0"
                  step="0.01"
              ...
              <div className="space-y-2">
                <Label htmlFor="restock-produce-price">New Unit Price (optional)</Label>
                <Input
                  id="restock-produce-price"
                  type="number"
                  min="0"
                  step="0.01"
              ...
              <div className="space-y-2">
                <Label htmlFor="restock-produce-notes">Notes</Label>
                <Input
                  id="restock-produce-notes"
