                  ...
                  <Table containerClassName="max-h-[500px] overflow-y-auto overflow-x-auto" className="relative">
                    <TableHeader className="sticky top-0 z-20">
                      <TableRow className="bg-muted/50">
                        <TableHead className="min-w-[150px] md:min-w-[200px] font-semibold bg-muted/50">Product</TableHead>
                        <TableHead className="text-center min-w-[80px] md:min-w-[100px] font-semibold bg-muted/50">Opening Qty</TableHead>
                        <TableHead className="text-center min-w-[60px] md:min-w-[80px] font-semibold bg-muted/50">Restock</TableHead>
                        <TableHead className="text-center min-w-[80px] md:min-w-[100px] font-semibold bg-muted/50">Closing Qty</TableHead>
                        <TableHead className="text-center min-w-[60px] md:min-w-[80px] font-semibold bg-muted/50">Sold</TableHead>
                        <TableHead className="text-right min-w-[90px] md:min-w-[120px] font-semibold bg-muted/50">Revenue</TableHead>
                        <TableHead className="text-right min-w-[90px] md:min-w-[120px] font-semibold bg-muted/50">Cost</TableHead>
                        <TableHead className="text-right min-w-[90px] md:min-w-[120px] font-semibold bg-muted/50">Profit</TableHead>
                        <TableHead className="text-right min-w-[60px] md:min-w-[80px] font-semibold bg-muted/50">Margin</TableHead>
                      </TableRow>
                    </TableHeader>
                    <TableBody>
