...
export default function ServiceExpenseTracker() {
  ...
  const loadData = async () => {
    ...
    try {
      const [categoriesRes, summaryRes, expensesRes] = await Promise.all([
        apiGet("/business/service-expenses/categories/"),
        apiGet(`/business/service-expenses/summary/?period=${period}`),
        apiGet("/business/service-expenses/"),
      ]);
  ...
  const handleAddExpense = async () => {
    ...
    try {
      await apiPost("/business/service-expenses/", {
        ...newExpense,
  ...
  const handleUpdateExpense = async () => {
    ...
    try {
      await apiPut(`/business/service-expenses/${editingExpense.id}/`, {
        ...newExpense,
        amount: parseFloat(newExpense.amount),
        category_id: newExpense.category_id || null,
      });
  ...
  const handleDeleteExpense = async (expenseId: number) => {
    ...
    try {
      await apiDelete(`/business/service-expenses/${expenseId}/`);
      toast({
        title: "Success",
  ...
  const handleAddCategory = async () => {
    ...
    try {
      await apiPost("/business/service-expenses/categories/", newCategory);
      toast({
        title: "Success",
  ...
  const handleExport = async () => {
    try {
      window.open(`/api/business/service-expenses/export/?format=csv&period=${period}`, '_blank');
    } catch (error) {
      toast({
        title: "Error",
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between mb-6 gap-4">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-2xl md:text-3xl font-bold text-foreground">Service Expense Tracker</h1>
              <p className="text-muted-foreground">Track expenses and monitor service profitability</p>
            </div>
          </div>
        ...
        {summary && (
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
            ...
            <Card className="bg-card border-border">
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                <CardTitle className="text-sm font-medium text-foreground">Service Revenue</CardTitle>
              ...
              <CardContent>
                ...
                <p className="text-xs text-muted-foreground">From invoices & projects</p>
              </CardContent>
            </Card>
              ...
              <CardContent>
                <div
                  className={`text-2xl font-bold ${
                    summary.summary.net_profit >= 0 ? "text-emerald-500" : "text-red-500"
                  }`}
                >
            ...
            <Card className="bg-card border-border">
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                <CardTitle className="text-sm font-medium text-foreground">Avg. Expense</CardTitle>
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab}>
          ...
          <TabsContent value="overview" className="space-y-6">
                    ...
                    <div className="h-[300px]">
                      <ResponsiveContainer width="100%" height="100%">
                        <BarChart data={summary.profit_trend}>
                          ...
                          <XAxis dataKey="month_name" stroke="hsl(var(--muted-foreground))" />
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <Card className="bg-card border-border">
                <CardHeader>
                  <CardTitle className="text-foreground">Top Expenses</CardTitle>
                  <CardDescription className="text-muted-foreground">Highest expenses this period</CardDescription>
                </CardHeader>
                <CardContent>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <Card className="bg-card border-border">
                <CardHeader className="pb-2">
                  <CardTitle className="text-sm font-medium text-foreground">Recurring Expenses</CardTitle>
                </CardHeader>
                <CardContent>
                  <div className="text-2xl font-bold text-foreground">
                    {formatCurrency(summary?.summary.recurring_expenses || 0)}
                  </div>
              ...
              <Card className="bg-card border-border">
                <CardHeader className="pb-2">
                  <CardTitle className="text-sm font-medium text-foreground">Tax Deductible</CardTitle>
                </CardHeader>
                <CardContent>
                  <div className="text-2xl font-bold text-foreground">
                    {formatCurrency(summary?.summary.tax_deductible_expenses || 0)}
                  </div>
                            ...
                            <TableRow key={expense.id} className="border-border">
                              ...
                              <TableCell>
                                <div className="flex items-center gap-2">
                                  ...
                                  >
                                    <IconComp className="h-3 w-3" style={{ color: expense.category_color }} />
                                  </div>
                                  <span className="text-foreground">{expense.category_name}</span>
                                </div>
                              </TableCell>
                              <TableCell className="text-foreground">{expense.vendor_name || '-'}</TableCell>
                              <TableCell>
              ...
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                  {categories.map((category) => {
                    ...
                    return (
                      <Card key={category.id} className="bg-muted/30 border-border">
                        <CardContent className="p-4">
                          <div className="flex items-center gap-3">
                            ...
                            <div className="flex-1">
                              ...
                              <p className="text-xs text-muted-foreground">
                                {category.expense_count} expenses • {formatCurrency(category.total_amount)}
                              </p>
                            </div>
                            {category.is_default && (
              ...
              <div className="md:col-span-2 space-y-4 pt-2">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">Mark as recurring expense</p>
                  </div>
                  <Switch
                ...
                {newExpense.is_recurring && (
                  <div className="space-y-2">
                    ...
                    <Select
                      ...
                      onValueChange={(value) => setNewExpense({ ...newExpense, recurring_frequency: value })}
                    >
                      <SelectTrigger>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">Mark for tax purposes</p>
                  </div>
                  <Switch
                    checked={newExpense.is_tax_deductible}
                    onCheckedChange={(checked) => setNewExpense({ ...newExpense, is_tax_deductible: checked })}
                  />
                </div>
              </div>
        ...
        <Dialog open={showAddCategory} onOpenChange={setShowAddCategory}>
          <DialogContent>
            <DialogHeader>
              ...
              <DialogDescription>Create a new category to organize expenses</DialogDescription>
            </DialogHeader>
