  ...
  const fetchDashboardData = async () => {
    try {
      ...
      if (settingsResponse.success && settingsResponse.business) {
        ...
        console.error('Settings API error:', settingsResponse.error);
        // Don't fail completely, continue to load dashboard
      }
      ...
      toast({
        title: "Error",
        description: "Failed to load services dashboard. Please try again.",
        variant: "destructive"
      });
    } finally {
      setIsLoading(false);
      ...
      <div className="min-h-screen bg-background p-4 md:p-8">
        <div className="max-w-7xl mx-auto">
          <Card className="p-8 text-center">
            ...
            <p className="text-muted-foreground mb-4">We couldn't load the services dashboard. Please check your connection and try again.</p>
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              {businessSlug && serviceEnabled && (
                <Button variant="outline" onClick={() => window.open(`${getAppBaseUrl()}/services/${businessSlug}`, '_blank')}>
