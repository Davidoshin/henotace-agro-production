          ...
          <DialogContent className="max-w-md">
            ...
            <div className="space-y-4 pt-2">
              <div className="space-y-2">
                <Label htmlFor="mobile-restock-input-item">Farm Resource</Label>
                <select
                  id="mobile-restock-input-item"
              ...
              <div className="space-y-2">
                <Label htmlFor="mobile-restock-input-qty">Quantity Added</Label>
                <Input
                  id="mobile-restock-input-qty"
                  type="number"
                  min="0"
                  step="0.01"
              ...
              <div className="space-y-2">
                <Label htmlFor="mobile-restock-input-cost">New Unit Cost (optional)</Label>
                <Input
                  id="mobile-restock-input-cost"
                  type="number"
                  min="0"
                  step="0.01"
              ...
              <div className="space-y-2">
                <Label htmlFor="mobile-restock-input-notes">Notes</Label>
                <Input
                  id="mobile-restock-input-notes"
