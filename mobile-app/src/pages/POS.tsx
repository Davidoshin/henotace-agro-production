  ...
  const connectPrinter = async () => {
    try {
      ...
      if (error.message?.includes('Failed to open serial port')) {
        ...
        errorMessage = "Printer is already connected to another tab or application.";
              ...
              <div className="space-y-3">
                ...
                {selectedCustomer ? (
                  <div className="text-sm text-muted-foreground">
                    Selected: <span className="font-medium text-foreground">{selectedCustomer.name || "Unnamed Customer"}</span>
                  </div>
                ) : (
                  <div className="text-sm text-muted-foreground">
