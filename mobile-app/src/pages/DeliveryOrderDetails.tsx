      ...
      <div className="sticky top-0 z-40 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 border-b">
        <div className="flex items-center justify-between p-4">
          ...
          <div className="flex gap-2">
            <Button variant="ghost" size="sm" onClick={loadOrderDetails} disabled={loading}>
              <RefreshCw className={`h-4 w-4 ${loading ? 'animate-spin' : ''}`} />
            </Button>
            <Button variant="ghost" size="sm" onClick={() => navigate(`/delivery-orders/${order.id}/edit`)}>
            ...
            <div className="flex items-center justify-between mb-3">
              <div>
                <div className="flex items-center gap-2 mb-1">
                  ...
                  <span className="font-semibold">{order.delivery_number}</span>
                </div>
        ...
        <Card>
          ...
          <CardContent className="space-y-3">
            <div className="flex items-start gap-3">
              <MapPin className="h-4 w-4 text-muted-foreground mt-0.5" />
              <div className="flex-1">
                <p className="text-sm font-medium">{order.dropoff_address}</p>
            ...
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium">{order.dropoff_contact_name}</p>
            ...
            <CardContent>
              <div className="bg-muted rounded-lg h-48 flex items-center justify-center">
                <div className="text-center text-muted-foreground">
                  ...
                  <p className="text-sm">Live tracking available</p>
                  <p className="text-xs">
