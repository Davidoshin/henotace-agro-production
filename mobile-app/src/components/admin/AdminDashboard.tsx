...
import { Users, CreditCard, FileText, BookOpen, Settings, LogOut, Upload, X, Building2, CheckCircle2, Truck } from 'lucide-react';
import { Dialog, DialogContent, DialogHeader, DialogTitle, DialogTrigger } from '@/components/ui/dialog';
import { SubjectSelect } from '@/components/ui/subject-select';
import AdminDeliveryManagement from './AdminDeliveryManagement';
import AccessDenied from './AccessDenied';

type AdminView = 'dashboard' | 'users' | 'subscriptions' | 'payments' | 'waec-questions' | 'jamb-questions' | 'subjects' | 'institutions' | 'delivery';
